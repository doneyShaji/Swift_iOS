    ...
    let containerView: UIView = {
        ...
        private func setupViews() {
            ...
            NSLayoutConstraint.activate([
                ...
                homeTableViewIMG.leadingAnchor.constraint(equalTo: containerView.leadingAnchor, constant: 10),
                homeTableViewIMG.widthAnchor.constraint(equalToConstant: 60),
                homeTableViewIMG.heightAnchor.constraint(equalToConstant: 60),
                
                homeTableViewTitle.topAnchor.constraint(equalTo: containerView.topAnchor, constant: 10),
                homeTableViewTitle.leadingAnchor.constraint(equalTo: homeTableViewIMG.trailingAnchor, constant: 10),
                ...
                homePriceLabel.leadingAnchor.constraint(equalTo: homeTableViewIMG.trailingAnchor, constant: 10),
                ...
                descriptionHomeLabel.leadingAnchor.constraint(equalTo: homeTableViewIMG.trailingAnchor, constant: 10),
                ...
                homeBrandLabel.leadingAnchor.constraint(equalTo: homeTableViewIMG.trailingAnchor, constant: 10),
